    ...
    <section className="new-hero">
      <style>{`
        ...
        .new-hero-pretitle {
          ...
          text-transform: uppercase; color: var(--primary-green); margin-bottom: 18px;
        }
        .new-hero-title { font-size: clamp(2.2rem, 4vw, 3.4rem); font-weight: 800; line-height: 1.2; color: var(--dark-text); margin-bottom: 22px; }
        .new-hero-title span { color: var(--primary-gold); }
        .new-hero-subtitle { font-size: 1.15rem; line-height: 1.7; color: var(--light-text); max-width: 480px; margin-bottom: 36px; }
